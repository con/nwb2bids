...
def test_dataset_converter_directory_initialization(
    ...
    dataset_converter = nwb2bids.DatasetConverter.from_nwb_paths(nwb_directory=nwb_directory)
...
def test_dataset_converter_file_paths_initialization(
    ...
    dataset_converter = nwb2bids.DatasetConverter.from_nwb_paths(nwbfile_paths=nwbfile_paths)
...
def test_dataset_converter_metadata_extraction(
    ...
    dataset_converter = nwb2bids.DatasetConverter.from_nwb_paths(nwb_directory=minimal_nwbfile_path.parent)
