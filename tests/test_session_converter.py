...
def test_session_converter_write_ecephys_metadata(
    ...
    session_converter.write_ecephys_metadata(bids_directory=temporary_bids_directory)
    ...
    sessions_tsv_file_path = temporary_bids_directory / "sub-123" / "ecephys" / "sub-123_sessions.tsv"
    ...
    sessions_json_file_path = temporary_bids_directory / "sub-123" / "ecephys" / "sub-123_sessions.json"
...
def test_session_converter_write_events_metadata(
    ...
    session_converter = session_converters[0]
    session_converter.extract_session_metadata()
    session_converter.write_events_metadata(bids_directory=temporary_bids_directory)
